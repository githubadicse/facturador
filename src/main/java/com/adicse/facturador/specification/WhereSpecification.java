package com.adicse.facturador.specification;

import com.adicse.facturador.specification.SpecificationException;
...
import static com.adicse.facturador.specification.Filter.*;
	...
	private Predicate doGetPredicate(CriteriaBuilder cb, Path<Object> path, String operator, Object value) throws SpecificationException {
        ...
        switch (operator) {
            ...
            case CONTAINS:
                ...
                p = cb.like( cb.upper( path.as(String.class ) ) , "%" + String.valueOf(value ).toUpperCase() + "%") ;
                break;
            case NOT_CONTAINS:
